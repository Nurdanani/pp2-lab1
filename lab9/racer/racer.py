...
# Инициализация Pygame и определение констант
pygame.init()
FPS = 60
...
# Определение шрифтов для текстовых элементов игры
font = pygame.font.SysFont("Verdana", 60)
font_small = pygame.font.SysFont("Verdana", 20)
game_over = font.render("Game Over", True, BLACK)

# Загрузка фонового изображения
background = pygame.image.load("lab2/lab9/racer/AnimatedStreet.png")
...
# Класс для вражеского спрайта
class Enemy(pygame.sprite.Sprite):
    def __init__(self):
        super().__init__()
        self.image = pygame.image.load("lab2/lab9/racer/Enemy.png")
...
class Player(pygame.sprite.Sprite):
    def __init__(self):
        super().__init__()
        self.image = pygame.image.load("lab2/lab9/racer/Player.png")
        self.rect = self.image.get_rect()
...
# Класс для спрайта монеты
class Coin(pygame.sprite.Sprite):
    def __init__(self):
        super().__init__()
        coin_image = pygame.image.load("lab2/lab9/racer/coin-removebg-preview.png")  
...
# Добавление пользовательского события для увеличения скорости игры
...
while True:
    ...
    # Отображение фона и текстовых элементов
    ...
    if pygame.sprite.spritecollideany(P1, enemies):
        pygame.mixer.Sound('lab2/lab9/racer/crash.wav').play()
        time.sleep(0.5)
